 ...
 *
 */
public class VCFVariantDensityCalculatorController extends AnalysisAreaController {
	
	//Constants.
	
	public static final String TASK_NAME = "VCF Variant Density";
	...
	public String getFXMLResourcePath() {
		return "/ngsepfx/view/VCFVariantDensityCalculator.fxml";
	}
	/* (non-Javadoc)
	...
	public void handleActivationEvent(NGSEPEvent event) {
		...
		setDefaultValues(VCFVariantDensityCalculator.class.getName());
		inputFileTextField.setText(file.getAbsolutePath());
		suggestOutputFile(file, outputFileTextField, "_density.txt");
	}

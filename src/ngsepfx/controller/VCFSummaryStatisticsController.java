...
public class VCFSummaryStatisticsController extends AnalysisAreaController {
	...
	public String getFXMLResourcePath() {
		return "/ngsepfx/view/VCFSummaryStatistics.fxml";
	}
	/* (non-Javadoc)
	...
	public void handleActivationEvent(NGSEPEvent event) {
		...
		setDefaultValues(VCFSummaryStatisticsCalculator.class.getName());
		inputFileTextField.setText(file.getAbsolutePath());
		suggestOutputFile(file, outputFileTextField, "_SummaryStats.txt");
	}
